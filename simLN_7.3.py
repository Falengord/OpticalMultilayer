...
from fun import material_nk_fnLN, material_nk_fnLNt, material_nk_fnGaN, material_nk_fnAl2O3, make_k, make_T_int, make_T_lay, make_layer_matr, T_inc
...
x, y = loadtxt('Dati/7.3 con bandwidth bassa 2.txt', delimiter='\t', unpack=True)



#save the result of the simulation on a file
d =array([lambda_list,Tinc]).T
savetxt('simLN_7.3.txt', d, fmt='%10.5f', newline='\n')
...
plt.savefig('Transmission_7.3.pdf')
plt.savefig('Transmission_7.3.svg')
